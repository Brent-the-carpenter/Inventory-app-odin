...
router.post("/category/:id/delete", category_controller.category_post_delete);

// GET/POST request for updating category
router.get("/category/:id/update", category_controller.category_get_update);
router.post("/category/:id/update", category_controller.category_post_update);
...
router.get("/location/:id/delete", location_controller.location_get_delete);
router.post("/location/:id/delete", location_controller.location_post_delete);

// GET/POST request for updating location.
router.get("/location/:id/update", location_controller.location_get_update);
router.post("/location/:id/update", location_controller.location_post_update);
...
router.post("/material/:id/delete", material_controller.material_post_delete);
